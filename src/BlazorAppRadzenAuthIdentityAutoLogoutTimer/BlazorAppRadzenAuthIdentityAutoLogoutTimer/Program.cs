using BlazorAppRadzenAuthIdentityAutoLogoutTimer.Components;
using BlazorAppRadzenAuthIdentityAutoLogoutTimer.Components.Account;
using BlazorAppRadzenAuthIdentityAutoLogoutTimer.Data;
using BlazorAppRadzenAuthIdentityAutoLogoutTimer.Models;
using BlazorAppRadzenAuthIdentityAutoLogoutTimer.Services;
using BlazorAppRadzenAuthIdentityAutoLogoutTimer.ViewModels;
using Mapster;
using MapsterMapper;
...
{
    public const string COOKIE_NAME = "YourAppCookieName";
    public static readonly TimeSpan EXPIRE_TIMESPAN = TimeSpan.FromMinutes(10);
