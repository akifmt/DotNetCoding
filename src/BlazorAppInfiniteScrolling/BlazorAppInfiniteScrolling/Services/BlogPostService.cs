using BlazorAppInfiniteScrolling.Data;
using BlazorAppInfiniteScrolling.Models;
using Microsoft.EntityFrameworkCore;

namespace BlazorAppInfiniteScrolling.Services;
...
public class BlogPostService
{
    ...
    public async Task<IEnumerable<BlogPost>> GetbyPage(int skip, int top)
    {
        _logger.LogInformation($"Called GetAllAsync.");
        var query = _context.BlogPosts.AsQueryable();
