...
public class FillerText
{
    ...
    public static string MediumText = "aaa";
    public static string ShortText = "aaa";
}
...
public class MigraDocStylesHelper
{
    /// <summary>
...
public class MigraDocCoverHelper
{
    /// <summary>
    ...
    public static void DefineCover(Document document)
    {
        ...
        paragraph = section.AddParagraph("A sample document");
...
public class MigraDocTableOfContentsHelper
{
    /// <summary>
    /// Defines the cover page.
    /// </summary>
    public static void DefineTableOfContents(Document document)
    {
        ...
        paragraph.Style = "TOC";
        Hyperlink hyperlink = paragraph.AddHyperlink("ExportedData");
        hyperlink.AddText("ExportedData\t");
        hyperlink.AddPageRefField("ExportedData");
...
public class MigraDocContentSectionHelper
{
    /// <summary>
...
public class MigraDocParagraphsHelper
{
...
public class MigraDocTablesHelper
{
...
public class MigraDocChartsHelper
{
...
public class MigraDocTablesExportedDataHelper
{
    public static void DefineTablesExportedData(Document document, List<string> headerColumnNames, List<string> dataColumns, char dataSplitChar)
    {
        Paragraph paragraph = document.LastSection.AddParagraph("Exported Data", "Heading1");
        paragraph.AddBookmark("ExportedData");

        DemonstrateSimpleTable(document, headerColumnNames, dataColumns, dataSplitChar);
    }

    public static void DemonstrateSimpleTable(Document document, List<string> headerColumnNames, List<string> dataColumns, char dataSplitChar)
    {
        document.LastSection.AddParagraph("Tables", "Heading2");
        ...
        for (int i = 0; i < headerColumnNames.Count; i++)
        {
            ...
            cell.AddParagraph(headerColumnNames[i]);
        }
        ...
        {
            row = table.AddRow();
            string[] dataItems = dataColumns[i].Split(dataSplitChar);
            for (int j = 0; j < dataItems.Length; j++)
            {
                Cell cell = row.Cells[j];
                cell.AddParagraph(dataItems[j]);
            }
        }
